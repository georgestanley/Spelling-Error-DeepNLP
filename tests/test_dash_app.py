...
from app import convert_to_numpy_valdata, generate_N_grams, generate_N_grams_onehot, \
    evaluate_lstm_context_semi_character, evaluate_lstm_context_one_hot, evaluate_lstm_wo_context, update_output

from lstm_spell_classifier_w_context import initialize_model as initialize_semi_character_w_context
from lstm_spell_classifier_w_context_onehot import  initialize_model as initialize_one_hot
from lstm_spell_classifier_wo_context import initialize_model as initialize_semi_character_wo_context
...
###### LOAD THE MODELS ######
device = 'cuda'
PATH_SEMI_CHARACTER = "models//semi_character_w_context.pth"
...
######
PATH_ONE_HOT = "models//onehot_w_context.pth"
...
######
PATH_WO_CONTEXT = "models//semi_character_wo_context.pth"
device = 'cuda'
